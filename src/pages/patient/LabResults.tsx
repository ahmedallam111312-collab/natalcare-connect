...
export default function LabResults() {
  ...
  const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      // 1. تحويل الصورة إلى Base64 مع الضغط لتقليل الحجم
      setLoadingState("ai");
      toast.info("جاري تجهيز الصورة وتحليلها بالذكاء الاصطناعي...");
      ...
      console.error(error);
      toast.error(error.message || "حدث خطأ أثناء تحليل أو رفع الصورة.");
